  ...
  MRB_TRY(&c_jmp) {
    ...
    switch (mrb_type(buf_obj)) {
      case MRB_TT_INTEGER:
        ...
        break;
      case MRB_TT_SYMBOL: {
        mrb_sym want = mrb_symbol(buf_obj);
        if (want == mrb_intern_lit(mrb, "tls_want_pollin") || want == mrb_intern_lit(mrb, "tls_want_pollout"))
...
mrb_wslay_event_recv(mrb_state *mrb, mrb_value self)
{
  ...
  if (err == WSLAY_ERR_NOMEM) {
    ...
    return MRB_WSLAY_ERROR(mrb_int_value(mrb, err));
  }
...
{
  return MRB_GET_STATUSCODE(mrb_int_value(mrb, wslay_event_get_status_code_received(((mrb_wslay_user_data *) DATA_PTR(self))->ctx)));
}

static mrb_value
mrb_wslay_event_get_status_code_sent(mrb_state *mrb, mrb_value self)
{
  return MRB_GET_STATUSCODE(mrb_int_value(mrb, wslay_event_get_status_code_sent(((mrb_wslay_user_data *) DATA_PTR(self))->ctx)));
}

static mrb_value
mrb_wslay_event_get_queued_msg_count(mrb_state *mrb, mrb_value self)
{
  return mrb_int_value(mrb, wslay_event_get_queued_msg_count(((mrb_wslay_user_data *) DATA_PTR(self))->ctx));
}

static mrb_value
mrb_wslay_event_get_queued_msg_length(mrb_state *mrb, mrb_value self)
{
  return mrb_int_value(mrb, wslay_event_get_queued_msg_length(((mrb_wslay_user_data *) DATA_PTR(self))->ctx));
}
...
mrb_wslay_get_rsv1(mrb_state *mrb, mrb_value self)
{
  ...
  return mrb_int_value(mrb, wslay_get_rsv1(rsv));
}
...
mrb_wslay_get_rsv2(mrb_state *mrb, mrb_value self)
{
  ...
  return mrb_int_value(mrb, wslay_get_rsv2(rsv));
}
...
mrb_mruby_wslay_gem_init(mrb_state* mrb) {
  ...
  *wslay_event_context_cl, *wslay_event_context_server_cl, *wslay_event_context_client_cl;
  ...
  mrb_hash_set(mrb, wslay_error_hash, mrb_int_value(mrb, WSLAY_ERR_WANT_WRITE), mrb_symbol_value(mrb_intern_lit(mrb, "want_write")));
  mrb_hash_set(mrb, wslay_error_hash, mrb_int_value(mrb, WSLAY_ERR_PROTO), mrb_symbol_value(mrb_intern_lit(mrb, "proto")));
  mrb_hash_set(mrb, wslay_error_hash, mrb_int_value(mrb, WSLAY_ERR_INVALID_ARGUMENT), mrb_symbol_value(mrb_intern_lit(mrb, "invalid_argument")));
  mrb_hash_set(mrb, wslay_error_hash, mrb_int_value(mrb, WSLAY_ERR_INVALID_CALLBACK), mrb_symbol_value(mrb_intern_lit(mrb, "invalid_callback")));
  mrb_hash_set(mrb, wslay_error_hash, mrb_int_value(mrb, WSLAY_ERR_NO_MORE_MSG), mrb_symbol_value(mrb_intern_lit(mrb, "no_more_msg")));
  mrb_hash_set(mrb, wslay_error_hash, mrb_int_value(mrb, WSLAY_ERR_CALLBACK_FAILURE), mrb_symbol_value(mrb_intern_lit(mrb, "callback_failure")));
  mrb_hash_set(mrb, wslay_error_hash, mrb_int_value(mrb, WSLAY_ERR_WOULDBLOCK), mrb_symbol_value(mrb_intern_lit(mrb, "wouldblock")));
  mrb_hash_set(mrb, wslay_error_hash, mrb_int_value(mrb, WSLAY_ERR_NOMEM), mrb_symbol_value(mrb_intern_lit(mrb, "nomem")));
  ...
  mrb_hash_set(mrb, wslay_status_code_hash, mrb_int_value(mrb, WSLAY_CODE_NORMAL_CLOSURE), mrb_symbol_value(mrb_intern_lit(mrb, "normal_closure")));
  mrb_hash_set(mrb, wslay_status_code_hash, mrb_int_value(mrb, WSLAY_CODE_GOING_AWAY), mrb_symbol_value(mrb_intern_lit(mrb, "going_away")));
  mrb_hash_set(mrb, wslay_status_code_hash, mrb_int_value(mrb, WSLAY_CODE_PROTOCOL_ERROR), mrb_symbol_value(mrb_intern_lit(mrb, "protocol_error")));
  mrb_hash_set(mrb, wslay_status_code_hash, mrb_int_value(mrb, WSLAY_CODE_UNSUPPORTED_DATA), mrb_symbol_value(mrb_intern_lit(mrb, "unsupported_data")));
  mrb_hash_set(mrb, wslay_status_code_hash, mrb_int_value(mrb, WSLAY_CODE_NO_STATUS_RCVD), mrb_symbol_value(mrb_intern_lit(mrb, "no_status_rcvd")));
  mrb_hash_set(mrb, wslay_status_code_hash, mrb_int_value(mrb, WSLAY_CODE_ABNORMAL_CLOSURE), mrb_symbol_value(mrb_intern_lit(mrb, "abnormal_closure")));
  mrb_hash_set(mrb, wslay_status_code_hash, mrb_int_value(mrb, WSLAY_CODE_INVALID_FRAME_PAYLOAD_DATA), mrb_symbol_value(mrb_intern_lit(mrb, "invalid_frame_payload_data")));
  mrb_hash_set(mrb, wslay_status_code_hash, mrb_int_value(mrb, WSLAY_CODE_POLICY_VIOLATION), mrb_symbol_value(mrb_intern_lit(mrb, "policy_violation")));
  mrb_hash_set(mrb, wslay_status_code_hash, mrb_int_value(mrb, WSLAY_CODE_MESSAGE_TOO_BIG), mrb_symbol_value(mrb_intern_lit(mrb, "message_too_big")));
  mrb_hash_set(mrb, wslay_status_code_hash, mrb_int_value(mrb, WSLAY_CODE_MANDATORY_EXT), mrb_symbol_value(mrb_intern_lit(mrb, "mandatory_ext")));
  mrb_hash_set(mrb, wslay_status_code_hash, mrb_int_value(mrb, WSLAY_CODE_INTERNAL_SERVER_ERROR), mrb_symbol_value(mrb_intern_lit(mrb, "internal_server_error")));
  mrb_hash_set(mrb, wslay_status_code_hash, mrb_int_value(mrb, WSLAY_CODE_TLS_HANDSHAKE), mrb_symbol_value(mrb_intern_lit(mrb, "tls_handshake")));
  ...
  mrb_hash_set(mrb, io_flags_hash, mrb_int_value(mrb, WSLAY_MSG_MORE), mrb_symbol_value(mrb_intern_lit(mrb, "msg_more")));
  mrb_hash_set(mrb, io_flags_hash, mrb_symbol_value(mrb_intern_lit(mrb, "msg_more")), mrb_int_value(mrb, WSLAY_MSG_MORE));

  mrb_value wslay_opcode_hash = mrb_hash_new_capa(mrb, 6 * 2);
  mrb_define_const(mrb, wslay_mod, "OpCode", wslay_opcode_hash);
  mrb_hash_set(mrb, wslay_opcode_hash, mrb_int_value(mrb, WSLAY_CONTINUATION_FRAME), mrb_symbol_value(mrb_intern_lit(mrb, "continuation_frame")));
  mrb_hash_set(mrb, wslay_opcode_hash, mrb_int_value(mrb, WSLAY_TEXT_FRAME), mrb_symbol_value(mrb_intern_lit(mrb, "text_frame")));
  mrb_hash_set(mrb, wslay_opcode_hash, mrb_int_value(mrb, WSLAY_BINARY_FRAME), mrb_symbol_value(mrb_intern_lit(mrb, "binary_frame")));
  mrb_hash_set(mrb, wslay_opcode_hash, mrb_int_value(mrb, WSLAY_CONNECTION_CLOSE), mrb_symbol_value(mrb_intern_lit(mrb, "connection_close")));
  mrb_hash_set(mrb, wslay_opcode_hash, mrb_int_value(mrb, WSLAY_PING), mrb_symbol_value(mrb_intern_lit(mrb, "ping")));
  mrb_hash_set(mrb, wslay_opcode_hash, mrb_int_value(mrb, WSLAY_PONG), mrb_symbol_value(mrb_intern_lit(mrb, "pong")));
